...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['P1 Icon', "Changes P1's Icon depending on what you type on Value 1"],
		['P2 Icon', "Changes P2's Icon depending on what you type on Value 1"],
		...
		['dont touch', "dont use this.... please"]
